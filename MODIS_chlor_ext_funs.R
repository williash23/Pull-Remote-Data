# Sara Williams
# 7/8/2015
# Functions to crop and extract MODIS chlorophyll-A 4km data. (L3m_8D_chl_chlor_a_4km.img)
################################################################################

#  Download of raw 8d Chlor MODIS data done in ArcMap using Marine Geospatial Ecology 
#   Tools toolbox. File names were then re-written using Bulk Rename Utility.
...
crop_fun <-function(x = out){
				...
				r <- raster(paste("E:/tmp/chlor_8day", x$chlor_8day_fn[1], sep="/"), ncdf=T, stopifNotEqualSpaced=FALSE)
